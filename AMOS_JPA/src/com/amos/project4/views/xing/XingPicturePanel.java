...
public class XingPicturePanel extends JPanel implements AbstractControlledView {

	private static final long serialVersionUID = 1L;
	Image img ;
	Image default_img ;
	public XingPicturePanel(XingDataController controller) {
		super();
	...
	public void modelPropertyChange(Observable o, Object arg) {
		if (arg != null && arg.getClass().equals(Client.class)) {
			Client c = (Client) arg;
			List<XingData> urls = c.getXingDatasByType(XingDataType.USER_PICTURE);
			try{
