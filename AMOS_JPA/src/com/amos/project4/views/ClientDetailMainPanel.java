...
public class ClientDetailMainPanel extends JPanel implements AbstractControlledView{
	...
	private void init(){
		...
		springLayout.putConstraint(SpringLayout.NORTH, personalInformationsPanel, 10, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, personalInformationsPanel, 4, SpringLayout.WEST, this);
		springLayout.putConstraint(SpringLayout.SOUTH, personalInformationsPanel, 130, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.EAST, personalInformationsPanel, -4, SpringLayout.EAST, this);
		personalInformationsPanel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Personal informations", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLACK));
		...
		sl_personalInformationsPanel.putConstraint(SpringLayout.NORTH, name_textField, 0, SpringLayout.NORTH, lblName);
		...
		sl_personalInformationsPanel.putConstraint(SpringLayout.NORTH, firstnameTextField, 0, SpringLayout.NORTH, lblName);
		...
		sl_personalInformationsPanel.putConstraint(SpringLayout.NORTH, PlaceTextField, 0, SpringLayout.NORTH, lblBirthdate);
