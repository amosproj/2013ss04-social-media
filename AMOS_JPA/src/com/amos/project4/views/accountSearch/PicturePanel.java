...
public class PicturePanel extends JPanel {
	...
	public PicturePanel() {
		...
		try {
			...
			// Image imgFondo = javax.imageio.ImageIO.read(new java.io.File(url.getPath()));
			 ...
			 default_img = imgFondo.getScaledInstance(50, 50, Image.SCALE_DEFAULT);
		} catch (IOException e) {
			e.printStackTrace();
		};
	...
	public void  repaintProfileImage(String url) throws IOException {
		if(url != null && !url.isEmpty()){	
	        ...
	        img = imgFondo.getScaledInstance(50, 50, Image.SCALE_DEFAULT);	
		}else{
			img = null;
			default_img = default_img.getScaledInstance(50, 50, Image.SCALE_DEFAULT);	
		}
	}
